...
class App extends React.Component {
  ...
  changelike(i, action) {
    ...
    fetch("/like", { method: "POST", body: likes })
  ...
  render() {
    return (
      <div className="appcontainer">
        ...
        <hr></hr>
        <div className="activityboard" id="photogal">
          {this.state.display === "timeline" ? (
            ...
            <Profile
              countofpics={this.state.countofpics}
              username={this.state.username}
            />
          )}
        </div>
